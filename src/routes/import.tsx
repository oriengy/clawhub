  ...
  const detect = async () => {
    ...
    try {
      ...
      if (items.length === 1) {
        ...
        setStatus(`发现 ${items.length} 个技能。请选择一个。`)
      }
    } catch (e) {
    ...
    <main className="section upload-shell">
      <div className="upload-header">
        <div>
          ...
          <p className="upload-subtitle">仅支持公开仓库。自动检测 SKILL.md。</p>
        </div>
        <div className="upload-badge">
          <div>仅公开仓库</div>
          <div className="upload-badge-sub">锁定 Commit</div>
        </div>
      </div>
        ...
        <div className="upload-fields">
          <label className="upload-field" htmlFor="github-url">
            <div className="upload-field-header">
              ...
              <span className="upload-field-hint">仓库、目录路径或文件</span>
            </div>
            <input
              id="github-url"
            ...
            <div className="upload-grid">
              <div className="upload-fields">
                ...
                <label className="upload-field" htmlFor="name">
                  <div className="upload-field-header">
                    <strong>显示名称</strong>
                    <span className="upload-field-hint">在列表中显示</span>
                  </div>
                  <input
                    id="name"
                    className="upload-input"
              ...
              <aside className="upload-side">
                <div className="upload-summary">
                  <div className="upload-requirement ok">Commit 已锁定</div>
